...
// Get users 51-150 (skip first 50 already sent in wave 1)
...
console.log(`📋 Wave 2: ${users.length} users — ${heCount} Hebrew, ${enCount} other languages`);
