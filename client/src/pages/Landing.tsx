...
export default function Landing() {
  ...
  return (
    <div dir={dir} style={{ minHeight: "100vh", background: "#fff", fontFamily: "'Inter','Segoe UI',sans-serif", overflowX: "hidden" }}>
      ...
      {/* ── AUTH SECTION ── */}
      <section style={{ padding: "80px 24px", background: "#fff", borderTop: "1px solid #e5e7eb" }}>
        <div style={{ maxWidth: 520, margin: "0 auto", textAlign: "center" }}>
          {/* Icon */}
          <div style={{ width: 72, height: 72, borderRadius: "50%", background: "linear-gradient(135deg,#6366f1,#8b5cf6)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 24px", boxShadow: "0 8px 32px rgba(99,102,241,0.3)" }}>
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>
              <circle cx="12" cy="7" r="4"/>
            </svg>
          </div>
          <h2 style={{ fontSize: "clamp(1.6rem,3.5vw,2.2rem)", fontWeight: 900, color: "#1e1b4b", marginBottom: 12, letterSpacing: "-0.02em" }}>
            {isRtl ? "התחבר והתחל לעבוד עכשיו" : "Sign in and start working now"}
          </h2>
          <p style={{ color: "#6b7280", fontSize: 16, marginBottom: 40, lineHeight: 1.7 }}>
            {isRtl ? "הקמת חשבון בחינם וקבל 10 אסימונים להתחלה. אין צורך בכרטיס אשראי." : "Create a free account and get 10 tokens to start. No credit card required."}
          </p>
          {/* Big CTA buttons */}
          <div style={{ display: "flex", flexDirection: "column", gap: 16, alignItems: "center" }}>
            <button
              onClick={handleOpenAuth}
              style={{ width: "100%", maxWidth: 380, background: "linear-gradient(135deg,#6366f1,#8b5cf6)", color: "#fff", border: "none", borderRadius: 16, padding: "18px 40px", fontWeight: 800, fontSize: 18, cursor: "pointer", boxShadow: "0 6px 24px rgba(99,102,241,0.4)", transition: "transform 0.15s, box-shadow 0.15s", display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}
              onMouseEnter={e => { e.currentTarget.style.transform = "scale(1.03)"; e.currentTarget.style.boxShadow = "0 8px 32px rgba(99,102,241,0.5)"; }}
              onMouseLeave={e => { e.currentTarget.style.transform = "scale(1)"; e.currentTarget.style.boxShadow = "0 6px 24px rgba(99,102,241,0.4)"; }}
            >
              ...
              {isRtl ? "הרשמה בחינם" : "Register for free"}
            </button>
            <button
              onClick={handleOpenAuth}
              style={{ width: "100%", maxWidth: 380, background: "transparent", color: "#6366f1", border: "2px solid #6366f1", borderRadius: 16, padding: "16px 40px", fontWeight: 700, fontSize: 16, cursor: "pointer", transition: "background 0.15s, color 0.15s", display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}
            ...
            >
              ...
              {isRtl ? "כניסה — יש לי כבר חשבון" : "Sign in — I already have an account"}
            </button>
          </div>
          {/* Trust badges */}
          <div style={{ display: "flex", gap: 24, justifyContent: "center", marginTop: 32, flexWrap: "wrap" }}>
            <span style={{ display: "flex", alignItems: "center", gap: 6, color: "#6b7280", fontSize: 13 }}>
              ...
              {isRtl ? "בחינם ללא כרטיס" : "Free, no credit card"}
            </span>
            <span style={{ display: "flex", alignItems: "center", gap: 6, color: "#6b7280", fontSize: 13 }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
              {isRtl ? "10 אסימונים בהקמה" : "10 free tokens on signup"}
            </span>
            <span style={{ display: "flex", alignItems: "center", gap: 6, color: "#6b7280", fontSize: 13 }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
              {isRtl ? "בטוח ומוצפן" : "Secure & private"}
            </span>
          </div>
        </div>
      </section>
