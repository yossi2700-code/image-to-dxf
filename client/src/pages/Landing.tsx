...
const he = {
  ...
  pricingPayPerUse: "לפי שימוש — קנה קרדיטים",
  pricingSubscription: "מנוי חודשי — בקרוב",
  pricingTokens: "קרדיטים",
  ...
  subDesc: "קרדיטים ללא הגבלה, ניהול צוות, גישת API וחשבונית מס חודשית. מתאים לסטודיות, מפעלים ומעצבים מקצועיים.",
  subFeatures: ["קרדיטים ללא הגבלה", "ניהול צוות", "גישת API", "חשבונית מס"],
  subCta: "השאר פרטים",
  paypalTrust: "רכישה מאובטחת באמצעות",
  legalNote: "החברה שומרת לעצמה את הזכות לסגור את השירות בהודעה מוקדמת. במקרה כזה ייעשה מאמץ סביר להחזיר קרדיטים שלא נוצלו או לתת זיכוי כספי יחסי.",
