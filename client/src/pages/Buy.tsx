      ...
      <div className="max-w-md mx-auto px-4 mb-16">
        ...
        <div className="flex gap-2 mb-5">
          ...
          <button
            type="button"
            disabled
            className="flex-1 py-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 border-2 border-white/5 bg-white/5 text-gray-500 cursor-not-allowed opacity-60 relative"
          >
            ...
            כרטיס אשראי
            <span className="absolute -top-2 -right-1 bg-gray-500 text-white text-[9px] font-bold px-1.5 py-0.5 rounded-full">בקרוב</span>
          </button>
        </div>
