...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 4px 32px rgba(0,0,0,0.10);">
  ...
  <tr><td style="padding:0 40px 20px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#f0fdf4;border-radius:14px;border:1px solid #bbf7d0;">
      <tr><td style="padding:20px 24px;">
        <div style="font-size:14px;font-weight:700;color:#15803d;margin-bottom:8px;">&#x1F4F2; Add to Home Screen &mdash; works like an app</div>
        <div style="font-size:13px;color:#374151;line-height:1.9;">
          Use DXF AI directly from your browser &mdash; no download needed.<br/>
          <strong>iPhone/iPad:</strong> Tap the Share button &#9650; &rarr; &ldquo;Add to Home Screen&rdquo;<br/>
          <strong>Android / Desktop:</strong> Tap the &#8853; icon in the address bar &rarr; &ldquo;Install&rdquo;<br/>
          <span style="color:#6b7280;font-size:12px;">It opens just like any regular app &mdash; fast and convenient.</span>
        </div>
      </td></tr>
    </table>
  </td></tr>
  ...
  <tr><td style="padding:0 40px 24px;">
    <div style="font-size:13px;color:#6b7280;line-height:1.9;border-top:1px solid #e5e7eb;padding-top:20px;">
      Got questions or feedback? Just <strong>reply to this email</strong> &mdash; we&rsquo;d love to hear from you &#x1F60A;<br/>
      <span style="font-size:12px;color:#9ca3af;">We read every email and reply personally.</span>
    </div>
  </td></tr>
