...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 4px 32px rgba(0,0,0,0.10);">
  ...
  <tr><td style="padding:16px 40px;background:#f9fafb;border-top:1px solid #e5e7eb;">
    <div style="font-size:11px;color:#d1d5db;line-height:1.8;">
      קיבלת מייל זה כיון שנרשמת ל-DXF AI.
      ${unsubscribeUrl ? `<a href="${unsubscribeUrl}" style="color:#9ca3af;text-decoration:underline;margin-right:8px;">הסר אותי מרשימת הדיוור</a>` : ""}
    </div>
  </td></tr>
...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 4px 32px rgba(0,0,0,0.10);">
  ...
  <tr><td style="background:#4f46e5;padding:14px 40px;">
    <div style="font-size:18px;font-weight:700;color:#ffffff;letter-spacing:1px;">DXF AI</div>
    <div style="font-size:12px;color:#c7d2fe;margin-top:2px;">Convert images to DXF files in seconds</div>
  </td></tr>

  <!-- Greeting -->
  <tr><td style="padding:36px 40px 20px;">
    <div style="font-size:24px;font-weight:700;color:#1e1b4b;line-height:1.3;">${greeting}! 🎉</div>
    <div style="font-size:15px;color:#6b7280;margin-top:8px;">Your account is ready. Here's what you need to know before you start.</div>
  </td></tr>
  ...
  <tr><td style="padding:0 40px 28px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,#eef2ff 0%,#e0e7ff 100%);border-radius:14px;border:1px solid #c7d2fe;">
      <tr><td style="padding:22px 28px;">
        <div style="font-size:11px;font-weight:700;color:#4f46e5;letter-spacing:1.5px;text-transform:uppercase;margin-bottom:6px;">Credits Balance</div>
        <div style="font-size:44px;font-weight:800;color:#4f46e5;line-height:1;">${opts.tokens}</div>
        <div style="font-size:13px;color:#6366f1;margin-top:4px;">free credits ready to use</div>
      </td></tr>
    </table>
  </td></tr>
  ...
  <!-- Tips heading -->
  <tr><td style="padding:0 40px 16px;">
    <div style="font-size:16px;font-weight:700;color:#1e1b4b;">2 Tips for the best results</div>
  </td></tr>
  ...
  <tr><td style="padding:0 40px 14px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#fafafa;border-radius:12px;border:1px solid #e5e7eb;">
      <tr><td style="padding:20px 24px;">
        <div style="font-size:13px;font-weight:700;color:#4f46e5;margin-bottom:6px;">&#x2728; AI Generation &mdash; How to write a good prompt?</div>
        <div style="font-size:13px;color:#374151;line-height:1.8;">
          Instead of typing just <span style="background:#fef3c7;padding:1px 5px;border-radius:4px;font-weight:600;">"dog"</span> &mdash; describe it fully:<br/>
          <span style="color:#4f46e5;font-weight:600;">"labrador sitting in profile, thick bold outlines, white background, laser cut style"</span><br/>
          <span style="color:#9ca3af;font-size:12px;">The AI understands exactly what you want &mdash; and the file comes out much better.</span>
        </div>
      </td></tr>
    </table>
  </td></tr>
  ...
  <tr><td style="padding:0 40px 32px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#fafafa;border-radius:12px;border:1px solid #e5e7eb;">
      <tr><td style="padding:20px 24px;">
        <div style="font-size:13px;font-weight:700;color:#4f46e5;margin-bottom:6px;">&#x1F4F7; Photo to lines &mdash; How to photograph correctly?</div>
        <div style="font-size:13px;color:#374151;line-height:1.8;">
          Want to convert a physical object to DXF? Place it on a <span style="background:#fef3c7;padding:1px 5px;border-radius:4px;font-weight:600;">white A4 sheet</span> and photograph straight from above.<br/>
          <span style="color:#9ca3af;font-size:12px;">High contrast between object and background = clean, accurate DXF lines.</span>
        </div>
      </td></tr>
    </table>
  </td></tr>
  ...
  <!-- CTA -->
  <tr><td style="padding:0 40px 36px;text-align:center;">
    <a href="${opts.siteUrl}" style="display:inline-block;background:#4f46e5;color:#ffffff;font-size:15px;font-weight:700;padding:16px 52px;border-radius:12px;text-decoration:none;letter-spacing:0.3px;box-shadow:0 4px 16px rgba(79,70,229,0.35);">Start Creating Now &rarr;</a>
    <div style="font-size:11px;color:#9ca3af;margin-top:12px;">dxfai.ai</div>
  </td></tr>
  ...
  <tr><td style="padding:20px 40px;background:#f9fafb;border-top:1px solid #e5e7eb;">
    <div style="font-size:12px;color:#6b7280;line-height:1.8;">
      Questions or need help? <a href="mailto:support@dxfai.ai" style="color:#4f46e5;text-decoration:none;font-weight:600;">support@dxfai.ai</a> &mdash; we reply within 24 hours.
    </div>
  </td></tr>
  ...
  <tr><td style="padding:16px 40px;background:#f9fafb;border-top:1px solid #e5e7eb;">
    <div style="font-size:11px;color:#d1d5db;line-height:1.8;">
      ...
      ${unsubscribeUrl ? `<a href="${unsubscribeUrl}" style="color:#9ca3af;text-decoration:underline;margin-left:8px;">Unsubscribe</a>` : ""}
    </div>
  </td></tr>
