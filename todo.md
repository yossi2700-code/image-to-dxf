...
## עדכונים - אפריל 2026 (סשן 5)

- [ ] תמונה לקווים: הוספת 2 כפתורי מצב עם תמונת דוגמה — מצב רגיל / מצב מפורט לחריטה
- [ ] תמונה לקווים: מצב מפורט — פרומפט שונה + עיבוד עם יותר טקסטורה ופרטים

## עדכונים - אפריל 2026 (סשן 5)

- [ ] תמונה לקווים: הוספת 2 כפתורי מצב עם תמונת דוגמה — מצב רגיל / מצב מפורט לחריטה (6 אסימונים)
- [ ] תמונה לקווים: מצב מפורט — פרומפט שונה + עיבוד עם יותר טקסטורה ופרטים
- [ ] תמונה לקווים: הצגת עלות אסימונים על כפתור המצב המפורט
