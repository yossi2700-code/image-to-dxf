...
## שיפור AI Sketch - מרץ 2026

- [x] החלפת fal.ai lineart ב-gpt-image-1: יצירת סקיצה נקייה מחדש — כל אות/תו כצורה גרפית, שחור על לבן, קווים חדים וברורים

## תיקוני SVG Viewer - מרץ 2026

- [x] קווים עבים יותר בתצוגת SVG — stroke-width גדול יותר לתצוגה ברורה וחדה
- [x] תיקון כפתור מסך מלא במובייל — לא עובד (Fullscreen API לא נתמך ב-iOS Safari, צריך fallback)
