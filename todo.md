...
- [ ] תיקון PDF ריק בייצוא
- [ ] הסרת כפתורי שיתוף מדיאלוג שמירה בשם
- [ ] סידור מחדש של דף ניהול
- [ ] הדמיות עיצוב בהשראת אדובי (לפני יישום)
- [ ] שינוי שם "AI מסמך" לשם מתאים יותר
- [ ] שינוי שם "AI מתמונה" לשם מתאים יותר
