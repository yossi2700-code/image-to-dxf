...
## Direct Trace Mode (No AI) - מרץ 2026

- [x] Add directTrace mode to aiTraceRoute.ts: background normalization + Otsu threshold + morphological cleanup + potrace (no AI)
- [x] Add directTrace parameter to POST /api/ai-trace route handler
- [x] Add "העתק ישיר" (Direct Copy) option in AiTraceTab UI
- [x] Test direct trace on pencil drawings with Hebrew text
