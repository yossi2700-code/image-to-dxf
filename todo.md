...
- [x] פתרון A: הוראת עובי קו מינימלי בכל הפרומפטים (minimum 4px regardless of zoom)
- [x] פתרון B: auto-crop חכם לאובייקט הראשי לפני שליחה ל-AI (bounding box detection)
