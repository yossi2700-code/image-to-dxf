...
## תיקונים - אפריל 2026 (המשך)

- [x] חימום שרת: שלח warm-up request ל-LLM כשמשתמש מעלה תמונה בפורטרט (לפני לחיצת "צור")
- [x] שיפור הודעת שגיאה: "לא זוהו פנים" — הודעה ברורה יותר עם הנחיות למשתמש
