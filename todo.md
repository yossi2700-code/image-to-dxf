...
## שיפורי UX מסך עיבוד - מרץ 2026
- [x] הוספת counter זמן "עיבוד: 1:23" ליד הודעת "עוד שניה"
- [x] הוספת הודעה שנייה ב-90 שניות "⏳ לוקח קצת יותר מהרגיל..."
- [x] Push Notification כשהמשתמש עוזב את הטאב והתמונה מוכנה

## שיפור סגנון AI Outline - מרץ 2026
- [x] עדכון פרומפט AI Outline לשמירה על סגנון ריאליסטי (לא קריקטורי/chibi)

## השוואה לפני/אחרי בתוצאת AI Outline - מרץ 2026
- [x] הוספת תצוגת לפני/אחרי בדף התוצאה של AI Outline (תמונה מקורית לצד DXF)

## שיפורים נוספים - מרץ 2026
- [x] חיזוק פרומפט ריאליסטי ב-AI Outline (חתול עדיין קריקטורי)
- [x] החלפת counter שניות באנימציית עיבוד מגניבה
- [x] הוספת זמן עיבוד בהיסטוריה (ניהול בלבד)

## פילטר זמן בפעולות אחרונות - מרץ 2026
- [x] הוספת כפתורי סינון יום/שבוע/חודש בטבלת פעולות אחרונות בניהול

## שינוי מצב נוף - מרץ 2026
- [x] שינוי שם "מצב נוף" ל"מצב כולל הרקע" בכל השפות
- [x] עדכון פרומפט: ברירת מחדל = מתמקד באובייקט (ללא רקע), מצב "כולל הרקע" = כולל סצנה מלאה

## שינויי טבלת ניהול - מרץ 2026
- [ ] קיפול כתובת IP ארוכה (IPv6) בטבלת פעולות אחרונות
- [ ] החלפת עמודת "קווים" בעמודת "נפח קובץ" (KB)

## עדכונים - מרץ 2026 (המשך)

- [x] הסתרת עמודת IP מטבלת הפעולות בדשבורד הניהול
- [x] החלפת עמודת "קווים" בעמודת "נפח" (גודל קובץ DXF ב-KB)
- [x] הוספת fileSizeKb לסכמת DB ולשרת (uploadRoute, aiTraceRoute, generateRoute)
- [x] הוספת durationMs לנתיב uploadRoute (זמן עיבוד המרה רגילה)

## תיקוני דשבורד ניהול - מרץ 2026

- [x] הגבלת גובה טבלת פעולות אחרונות (max-height + overflow-y scroll) — לא גלילה אינסופית
- [x] הסתרת כתובת IP כברירת מחדל, חשיפה בלחיצה
- [x] הוספת עמודת "זמן עיבוד" להיסטוריית פעולות משתמש

## פילטר ו-IP דשבורד - מרץ 2026
- [x] הוספת IP עם חשיפה בלחיצה בטבלת פעולות אחרונות
- [x] הוספת פילטר (סוג / תאריך / משתמש) לטבלת פעולות אחרונות
- [x] בדיקת זיהוי פנים במצב פורטרט — שגיאה ברורה אם לא זוהו פנים
