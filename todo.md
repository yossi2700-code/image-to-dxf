...
## DXF קווים סגורים - מרץ 2026

- [x] הוספת אפשרות הורדת DXF עם קווים סגורים (closed polylines) כדי שצביעת מילוי בתוכנות עיצוב תעבוד נכון

## תיקון איכות SVG/DXF - מרץ 2026

- [ ] קווים כהים וחדים יותר בתצוגה (stroke שחור #000 במקום #1a1a2e)
- [ ] תיקון potrace: paths עם stroke בלבד (ללא fill) כדי שצביעת מילוי תעבוד נכון

## DXF תמיד סגור - מרץ 2026

- [x] DXF תמיד עם קווים סגורים כברירת מחדל — הסרת כפתור "DXF לצביעה" נפרד
